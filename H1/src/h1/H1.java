...
public class H1 {
 ...
 /*
     ...
     * Permite finalizar la transacion de datos con la DB
       ...
       /**
        * realiza las consultas HQL o SQL NO GESTIONA EXCEPCIONES TRANSACCIONES
        */
       public static void consultarUltimosFilmActualizados() {
              ...
              Iterator itrListaResultados = listaResultadosSQL.iterator();
       ...
       // EJEMPLO 2: Persistencia, obtención, modificación y borrado de objetos en Hibrenate con gestion transaciones
       public static void realizaTransacion() {
              ...
              try {
                     ...
                     sess.save(actor1); //Copy the state of the given object onto the persistent object with the same identifier.

                     // Caso 2: obteniendo un objeto
                     short i = 201; // indice de la serie
                     actor2 = (Actor) sess.get(Actor.class, i);
                     if (actor2 != null) {
                            System.out.println(actor2.getActorId() + " " + actor2.getFirstName());
                     } else {
